%this file includes old configuration settings.
%Inputs:  None.
%Outputs: None.

function cs = Old_config_setting()
% MATLAB function for configuration set generated on 12-Jun-2020 19:58:39
...
cs.set_param('StopTime', '10');   % Stop time
