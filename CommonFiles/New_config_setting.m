%this file includes new configuration settings.
%Inputs:  None.
%Outputs: None.

function cs = New_config_setting()
% MATLAB function for configuration set generated on 12-Jun-2020 19:59:35
...
cs.set_param('StopTime', '5');   % Stop time
